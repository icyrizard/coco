...
/* arrays to convert types into strings */
    ...
    switch(BINOP_OP(arg_node)) {
        ...
        case BO_ne:
            ...
            if(left == TYPE_bool || right == TYPE_bool)
                ...
                if(left == TYPE_float)
                    CTIerror(":%d: error: cannot compare expression of type 'float' with expression of type 'int'",
                            NODE_LINE(arg_node));
                else
                    CTIerror(":%d: error: cannot compare expression of type 'int' with expression of type 'float'",
                            NODE_LINE(arg_node));
            else
